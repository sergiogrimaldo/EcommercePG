...
router.use('/availableSizes', SizesRoutes); // http://localhost:3001/shoes
router.use('/prices', PricesRoutes); // http://localhost:3001/shoes
...
router.use('/orders', ordersRoutes)  // http://localhost:3001/sendmail
