        ...
        try {
            ...
            for (let x = 0; x < allShoes.length; x++) {
                ...
                const talles = await AvailableSizes.create({
                    ...
                    "11": resellPrices.flightClub["11"] ? Math.floor(Math.random() * 15) + 1 : 0,
                    "11,5": resellPrices.flightClub["11.5"] ? Math.floor(Math.random() * 15) + 1 : 0,
                    "12": resellPrices.flightClub["12"] ? Math.floor(Math.random() * 15) + 1 : 0,
                ...
                const prices = await Price.create({
                    retailPrice: retailPrice ? retailPrice : Math.floor(Math.random() * 150) + 100,
                    ...
                    "11": resellPrices.flightClub["11"],
                    "11,5": resellPrices.flightClub["11.5"],
                    "12": resellPrices.flightClub["12"],
