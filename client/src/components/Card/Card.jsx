...
export default function Card({ shoe }) {
	...
	return (
		...
		<button className={s.button} style={{zIndex:30,borderRadius:10,position:'absolute',bottom:65,left:'38.%',zIndex:10,padding:5, border:'1px solid black'}}
		onClick={() => (handleClick())}
		>🛒 add to cart</button>
		</div>
	);
