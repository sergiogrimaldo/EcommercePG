	...
	if (description && shoeName && retailPrice) {
		try {
			...
			const sizes = await AvailableSizes.create({
				...
				'11': avaiableSizes[15] > 0 ? Math.floor(Math.random() * 15) + 1 : 0,
				'11,5': avaiableSizes[16] > 0 ? Math.floor(Math.random() * 15) + 1 : 0,
				'12': avaiableSizes[17] > 0 ? Math.floor(Math.random() * 15) + 1 : 0,
				'12,5': avaiableSizes[18] > 0 ? Math.floor(Math.random() * 15) + 1 : 0,
				'13': avaiableSizes[19] > 0 ? Math.floor(Math.random() * 15) + 1 : 0,
				'14': avaiableSizes[20] > 0 ? Math.floor(Math.random() * 15) + 1 : 0,
				'15': avaiableSizes[21] > 0 ? Math.floor(Math.random() * 15) + 1 : 0,
				'16': avaiableSizes[22] > 0 ? Math.floor(Math.random() * 15) + 1 : 0,
			...
			const prices = await Price.create({
				...
				'4': avaiableSizes[1] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'4,5': avaiableSizes[2] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'5': avaiableSizes[3] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'5,5': avaiableSizes[4] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'6': avaiableSizes[5] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'6,5': avaiableSizes[6] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'7': avaiableSizes[7] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'7,5': avaiableSizes[8] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'8': avaiableSizes[9] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'8,5': avaiableSizes[10] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'9': avaiableSizes[11] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'9,5': avaiableSizes[12] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'10': avaiableSizes[13] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'10,5': avaiableSizes[14] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'11': avaiableSizes[15] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'11,5': avaiableSizes[16] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'12': avaiableSizes[17] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'12,5': avaiableSizes[18] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'13': avaiableSizes[19] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'14': avaiableSizes[20] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'15': avaiableSizes[21] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
				'16': avaiableSizes[22] > 0 ? Math.floor(Math.random() * 500) + 150 : 0,
